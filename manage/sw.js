const CACHE_NAME = 'ss-manager-v42';
const STATIC_CACHE = 'ss-static-v42';
const DYNAMIC_CACHE = 'ss-dynamic-v42';
...
self.addEventListener('activate', event => {
  event.waitUntil(
    caches.keys().then(keys => {
      return Promise.all(
        keys.filter(key => !key.includes("v42")))
